...
void I2cMcuFormat( I2c_t *obj, I2cMode mode, I2cDutyCycle dutyCycle, bool I2cAckEnable, I2cAckAddrMode AckAddrMode, uint32_t timing )
{
    I2C_HandleTypeDef *i2c;

    __HAL_RCC_I2C1_CLK_ENABLE( );
    obj->I2c.Init.Timing = timing;
