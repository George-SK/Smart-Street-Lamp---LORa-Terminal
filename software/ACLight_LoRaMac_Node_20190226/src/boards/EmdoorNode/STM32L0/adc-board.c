...
void AdcMcuConfig( void )
{
    ...
    AdcHandle.Init.SamplingTime          = ADC_SAMPLETIME_239CYCLES_5;//ADC_SAMPLETIME_160CYCLES_5;  /* ADC_SAMPLETIME_239CYCLES_5; The origin driver is too old */	//Modified by Steven for using origin driver.
