    ...
    switch( getPhy->Attribute )
    {
        ...
        case PHY_DEF_TX_DR:
        {
            //phyParam.Value = AS923_DEFAULT_DATARATE;
					  phyParam.Value = JoiningLastDatarate; //George@20180824:use join network DR
            break;
        }
...
bool RegionAS923Verify( VerifyParams_t* verify, PhyAttribute_t phyAttribute )
{
    switch( phyAttribute )
    {
        ...
        case PHY_DEF_TX_DR:
        {
            return RegionCommonValueInRange( verify->DatarateParams.Datarate, DR_0, DR_6 );
        }
        case PHY_RX_DR:
        {
...
bool RegionAS923RxConfig( RxConfigParams_t* rxConfig, int8_t* datarate )
{
    ...
    else
    {
		...
		//Uart1.PrintfLog("RX Freq:%d DR:%d BW:%d\r\n", frequency, dr, rxConfig->Bandwidth); //George@20180825:test code
...
bool RegionAS923TxConfig( TxConfigParams_t* txConfig, int8_t* txPower, TimerTime_t* txTimeOnAir )
{
    ...
    else
    {
		...
		//Uart1.PrintfLog("TX Freq:%d DR:%d BW:%d\r\n", Channels[txConfig->Channel].Frequency, txConfig->Datarate, bandwidth); //George@20180825:test code
...
//George@20180824:Alternate join network datarate
int8_t RegionAS923AlternateDr( AlternateDrParams_t* alternateDr )
{
    int8_t datarate = 0;
...
uint8_t RegionAS923ApplyDrOffset( uint8_t downlinkDwellTime, int8_t dr, int8_t drOffset )
{
    ...
    return MIN( DR_6, MAX( minDr, dr - EffectiveRx1DrOffsetAS923[drOffset] ) );  //George@20180825:modify DR_5 -> DR_6
}
